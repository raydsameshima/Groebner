...
\end{eqnarray}
Thus there is a non constant polynomial with no root, i.e., $F$ is not algebraically closed.\\
$\blacksquare$
...
\end{eqnarray}
Then this $I'$ is an ideal of $\mathbb{K}[\tilde{x}_2, \cdots, \tilde{x}_n]$.

\subsubsection{Proof}
Since $0 \in I$ has no $x_1$, so
\begin{eqnarray}
0 \in I'.
\end{eqnarray}
...
\end{eqnarray}
So $f' * g' \in I$ with no $x_1$ dependence, and
\begin{eqnarray}
f'g' \in I'.
\end{eqnarray}
...
\end{eqnarray}
Note that the diagonal elements are $N$-$f_0$'s and $M$-$g_e$'s.

\subsection{Resultant of ideal}
...
\begin{eqnarray}
\det A = \sum_{j=1}^n A_{i_0, j} \Delta_{i_0, j}
\end{eqnarray}
where $\Delta_{i_0, j}$ is the $(i_0,j)$ minor (determinant) of $A$:
\begin{eqnarray}
\Delta_{i_0, j} := (-)^{i_0+j} A \left(\begin{array}{cccccc}1 & \cdots  &  i_0-1 & i_0+1  & \cdots  & n  \\ 1 & \cdots  & j-1  & j+1  & \cdots  & n \end{array}\right)
\end{eqnarray}
...
\end{eqnarray}
with $c(\lambda_2, \cdots, \lambda_n)$ is non zero polynomial. 
...
\end{eqnarray}
This is the only term which survive under $\tilde{x}_2 = \cdots \ \tilde{x}_{n} = 0$, and indeed
\begin{eqnarray}
...
\end{eqnarray}
then\footnote{
For an arbitrary $I \subset \mathbb{K}[x_1, \cdots, x_n]$,
\begin{eqnarray}
...
Let us assume the statement holds for $(n-1)$ variables $\mathbb{K}[x_2, \cdots, x_n]$ with $n >1$.
For an arbitrary proper ideal $I \subsetneq \mathbb{K}[x_1, \cdots, x_n]$, define an ideal (as above lemma \S\ref{firstElimination})
\begin{eqnarray}
I' &:=& \left\{ \left. f' \in I \right| f' \text{ does not contain any $x_1$} \right\} \\
&\subset& \mathbb{K}[x_2, \cdots, x_n]
\end{eqnarray}
Since $1 \not\in I$ and so as $I'$,
\begin{eqnarray}
1 \not \in I'
\end{eqnarray}
i.e., $I'$ is a proper ideal of $\mathbb{K}[x_2, \cdots, x_n]$.
By induction hypothesis,
\begin{eqnarray}
\exists (a_2, \cdots, a_n) \in \mathbb{K}^{n-1}, \forall f' \in I', f'(a_2, \cdots, a_n) = 0.
\end{eqnarray}

We claim that with this specific $(a_2, \cdots, a_n)$,
\begin{eqnarray}
J := \left\{\left. f(x_1, a_2, \cdots, a_n) \right| f\in I \right\} 
\end{eqnarray}
is a proper ideal of $\mathbb{K}[x_1]$.
We prove this by contradiction; 

\paragraph{Proof}
Suppose there exists $f \in I$ of constant polynomial s.t.
\begin{eqnarray}
\forall \tilde{x}_1 \in \mathbb{K},  f(x_1, a_2, \cdots, a_n) = 1.
\end{eqnarray}
If we expand this $f(x_1, \tilde{x}_2, \cdots, x_n) $ with respect to $x_1$
\begin{eqnarray}
f = \sum_{r=0}^M f_r x_1^r
\end{eqnarray}
then each $f_r \in \mathbb{K}[x_2, \cdots, x_n]$ satisfies
\begin{eqnarray}
f_0(a_2, \cdots, a_n) = 1 \\
f_1(a_2, \cdots, a_n) = \cdots = f_M(a_2, \cdots, a_n) = 0.
\end{eqnarray}

Consider an arbitrary polynomial $g \in I$ of total degree $N \geq 1$.
By choosing (and fixing) appropriate $(\lambda_2, \cdots, \lambda_n)$ we can choose nonzero $c$ with
\begin{eqnarray}
\tilde{g}(\tilde{x}_1, \tilde{x}_2, \cdots, \tilde{x}_n) = \sum_{r=0}^{N-1} g_r \tilde{x}_1^{r} + c \tilde{x}_1^N
\end{eqnarray}
Since $c \neq 0$,
\begin{eqnarray}
\frac{1}{c} \tilde{g} \in \tilde{I},
\end{eqnarray}
the resultant of $\tilde{f} \in \tilde{I}$ and this $\frac{\tilde{g}}{c} \in \tilde{I}$ with respect to $\tilde{x}_1$ at $\tilde{x}_2 = \tilde{a}_2, \cdots, \tilde{x}_n = \tilde{a}_n$ becomes $1$, since at $\tilde{x}_2 = \tilde{a}_2, \cdots, \tilde{x}_n = \tilde{a}_n$
\begin{eqnarray}
\nonumber
\left. R\left(\tilde{f}, \frac{\tilde{g}}{c}; \tilde{x}_1 \right) \right|_{\tilde{x}_2 = \tilde{a}_2, \cdots, \tilde{x}_n = \tilde{a}_n}
&=&
\det\left(\begin{array}{ccccccc} 1 & 0 & \cdots  & 0 &   &   &   \\ & 1 & 0 & \cdots  & 0 &   &   \\  &   & \ddots  &   &   & \ddots  &   \\  &   &   &  1 & 0 & \cdots  & 0  \\ \frac{g_0}{c}  & \frac{g_1}{c}   & \cdots  & \frac{g_{N-1}}{c}  & 1 &   &   \\  &  \ddots &   &   &   &  \ddots &   \\  &   &  \frac{g_0}{c} &  \frac{g_1}{c} & \cdots  & \frac{g_{N-1}}{c}  & 1 \end{array}\right)\\
&=& 1
\end{eqnarray}
...
Therefore $J$ is a proper ideal
\begin{eqnarray}
J := \left\{\left. f(x_1, a_2, \cdots, a_n) \right| f\in I \right\} \subsetneq \mathbb{K}[x_1].
\end{eqnarray}

Now if $J \neq \{0\}$, then there exists non constant polynomial $h(x_1)$ with
\begin{eqnarray}
J = \left< h(x_1) \right>
\end{eqnarray}
Since $\mathbb{K}$ is algebraically closed, there exists some $a_1 \in \mathbb{K}$ s.t.
\begin{eqnarray}
h(a_1) = 0.
\end{eqnarray}
Therefore,
\begin{eqnarray}
\forall f \in I, f(a_1, a_2, \cdots, a_n) = 0.
\end{eqnarray}
Else if $J = \{0\}$, then
\begin{eqnarray}
\forall x_1, f(x_1, a_2, \cdots, a_n) = 0
\end{eqnarray}

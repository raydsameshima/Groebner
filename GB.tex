...
\end{eqnarray}
%Every element of $\mathbb{K}[x_1,\cdots,x_n]$ determine a function: $\forall f(x) \in \mathbb{K}[x_1,\cdots,x_n]$,
%\begin{eqnarray}
%f(x) = \sum_\alpha c_\alpha * x^\alpha : \mathbb{K}^n \to \mathbb{K}; a \mapsto \sum_\alpha c_\alpha * a^\alpha
%\end{eqnarray}
%by replacing every $x_i$ by $a_i$.
